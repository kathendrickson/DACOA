...
# Problem Parameters 
A = np.zeros((66,15))
A[[0,5,14,1],[1,1,1,1]] = 1
A[[0,6,3,2,16,15,1],[8,8,8,8,8,8,8]] = 1
A[[0,7,9,13,2],[3,3,3,3,3]] = 1
A[[0,4,12,15,1],[5,5,5,5,5]] = 1
A[[0,6,10,8,11,13,1],[7,7,7,7,7,7,7]] = 1
A[[17,35,28,27,36,38,18],[14,14,14,14,14,14,14]] = 1
A[[17,34,33,39,19,20,26,25,18],[2,2,2,2,2,2,2,2,2]] = 1
A[[17,35,39,37,26,25,18],[13,13,13,13,13,13,13]] = 1
A[[17,23,22,33,32,31,30,21,20,36,38,18],[12,12,12,12,12,12,12,12,12,12,12,12]] = 1
A[[17,35,39,29,27,36,24,25,18],[6,6,6,6,6,6,6,6,6]] = 1
A[[40,50,51,52],[0,0,0,0]] = 1
A[[40,63,49,52,55,57,41],[10,10,10,10,10,10,10]] = 1
A[[40,45,46,62,59,56,43,44,53,41],[11,11,11,11,11,11,11,11,11,11]] = 1
A[[40,63,65,47,48,56,54,64,41],[4,4,4,4,4,4,4,4,4]] = 1
A[[40,63,61,60,58,56,54,64,41],[9,9,9,9,9,9,9,9,9]] = 1
